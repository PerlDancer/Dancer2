...
By default, the internal template engine is used (L<Dancer::Template::v2::Simple>)
...
L<Dancer::Template::v2::TemplateToolkit>. If you do so, you'll also have to import
