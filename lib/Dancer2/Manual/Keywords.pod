...
# TODO: splats
# TODO: captures
# TODO: Order keywords as they are in manual?
# TODO: make section order match manual
# TODO: review verbiage
...
relevant section in the L<Dancer2 Manual>.
...
=head2 L<header|Dancer2::Manual/header>

Sets an HTTP header in the response.

B<When to use>: Add or modify response headers.

B<Related Keywords>: C<content_type>, C<status>.
