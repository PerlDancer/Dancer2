...
This hook was named B<before_error_init> in Dancer, and is now aliased to this hook.
...
This hook was named B<before_error_render> in Dancer, and is now aliased to this hook.

=item before

This hook receives one argument, the route being executed (a
L<Dancer2::Core::Context> object).
...
This hook was named B<after_error_render> in Dancer, and his now aliased to this hook.
