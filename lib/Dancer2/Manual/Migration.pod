...
$Dancer2::Manual::Migration::VERSION = '0.159002';
use strict;
use warnings;
...
=show_errors
    The configuration C<show_errors> has been renamed to C<show_stacktrace>, which describes what it does better.
    Please note that C<show_errors> is still available but is now deprecated and will eventually be removed.
