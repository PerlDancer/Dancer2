...
C<session_name> changed to C<cookie_name>.
C<session_domain> changed to C<cookie_domain>.
C<session_expires> changed to C<cookie_duration>.
C<session_secure> changed to C<is_secure>.
C<session_is_http_only> changed to C<is_http_only>.
