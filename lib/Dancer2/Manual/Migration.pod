...
=head3 Session Engines: Configuration

In L<Dancer2>, configuration of the session engines is passed to the 
...
The following attributes need to be added to your engine class, to make 
C<dsn> and C<schema_class> B<read only>:
