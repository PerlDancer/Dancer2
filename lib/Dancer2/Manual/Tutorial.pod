...
=item Improved styling by using L<https://getbootstrap.com|Bootstrap> or another CSS framework

=item Replace homegrown functionality (such as messages) with other Dancer2 plugins
