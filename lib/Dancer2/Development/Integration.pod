# ABSTRACT: Development guide for Dancer2's core developers
# PODNAME: Dancer2::Development::Integration
...
A GitHub user who had forked and cloned the official Dancer2's repo, and
who has sent a PR.

=item * Integration branch

This branch is the branch used to merge all contributions. This is a
git-flow convention. In Dancer2, our integration branch is C<devel>.

As explained in L<Dancer2::Development>, every PR should be based on
...
A member of Dancer2's core-team who is responsible for reviewing and
...
instructions described in L<Dancer2::Development> so his work is based
...
Since Dancer2 1.2, we also have another parallel release cycle which is what we
...
Let's take an example with Dancer2 1.2003 and Dancer2 1.3002.

=over 4

=item *

Dancer2 1.2003 is the last stable release of Dancer2. Its codebase is handled in
the I<frozen> branch, that has been created from the tag C<1.2000>.

=item *

Dancer2 1.3002 is the last release of Dancer2. As it belongs to a development
