...
To define a GET action, use the L<get|Dancer2::Manual::Keywords/get> keyword.

=item B<POST> The POST method is used to create a resource on the server.

To define a POST action, use the L<post|Dancer2::Manual::Keywords/post> keyword.

=item B<PUT> The PUT method is used to replace an existing resource.

To define a PUT action, use the L<put|Dancer2::Manual::Keywords/put> keyword.
...
To define a DELETE action, use the L<del|Dancer2::Manual::Keywords/del> keyword.
