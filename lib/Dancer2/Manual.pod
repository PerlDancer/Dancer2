...
parameters you want: C<route_parameters>, C<request_parameters>, and
C<body_parameters>.
...
The L<request_parameters|Dancer2::Manual/request_parameters> keyword provides
...
match will be set in the params hashref.
    ...
    get '/hello/:name' => sub {
        ...
        # or
        "Hey " . request_parameters->get('name') . ", welcome here!";
    };
...
(C<route_parameters>, C<request_parameters>, and C<body_parameters>)
...
Returns a L<Hash::MultiValue> object from the request parameters.
    ...
    /?foo=hello
    get '/' => sub {
        my $name = request_parameters->get('foo');
    };

    /?name=Alice&name=Bob
    get '/' => sub {
        my @names = request_parameters->get_all('name');
    };
