...
Please note that this not recommended for production for performance reasons. This is the Dancer2
replacement solution of the old Dancer experimental C<auto_reload> option.
