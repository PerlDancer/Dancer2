...
If you want use redirect from a mounted package to root uri like the sample
below. It's helpful to use Dancer2::Plugin::RootURIFor with this plugin
it's possible like the following sample:
