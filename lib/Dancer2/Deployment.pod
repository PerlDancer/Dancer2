...
B<The code below does not work. It's the most important section on this page. Please fix.>
B<For example, there exists no set_running_app method anywhere in the D2.>
B<Also, nowhere else on the web can this information be found.>
