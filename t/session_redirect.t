...
my $client = sub {
    ...
    is $res->content, q{one:bar:ugh}, 'Session value preserved after chained redirects';
    ...
    is $res->content, q{one:bar:}, 'Session value preserved after redirect from route';
};
